<%@ Page Language="C#" MasterPageFile="~/Main2.Master" AutoEventWireup="true" CodeBehind="home.aspx.cs" Inherits="webStore.home" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="main" runat="server">
    <form id="form1" runat="server">
        <div class="text-center">
            ...
            <br />
            <br />
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:StoreConnectionString %>" SelectCommand="SELECT [product_name], [price], [image], [id_product], [visible], [quantity] FROM [Products] WHERE (([visible] = @visible) AND ([id_user] != @id_user) AND ([quantity] &gt; @quantity))">
                <SelectParameters>
