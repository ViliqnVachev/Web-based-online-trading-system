<%@ Page Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="homeNoRegister.aspx.cs" Inherits="webStore.homeNoRegister" %>
            ...
            <table class="nav-justified">
                <tr>
                    ...
                    <td class="auto-style3">
                        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AutoGenerateColumns="False" CssClass="auto-style4" DataSourceID="SqlDataSource1" Height="750px" GridLines="None" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" Width="950px"  DataKeyNames="id_product">
