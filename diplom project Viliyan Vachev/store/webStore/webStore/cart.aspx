        ...
        <table class="nav-justified">
            ...
            <tr>
                ...
                <td class="auto-style12">
                    ...
                    <asp:GridView ID="GridView1" runat="server" AllowPaging="True" GridLines="None" AutoGenerateColumns="False" DataSourceID="SqlDataSource1" Width="500px">
                    ...
                    <div class="text-right">
                        <br />
                        <br />
                        <asp:Label ID="EmptyCartsLable" runat="server" CssClass="auto-style7" ForeColor="Red" Text="You don't have items in your cart" Visible="False"></asp:Label>
                        <br />
                        <br />
