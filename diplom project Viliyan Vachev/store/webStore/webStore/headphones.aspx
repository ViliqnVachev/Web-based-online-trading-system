<%@ Page Language="C#" MasterPageFile="~/Main2.Master" AutoEventWireup="true" CodeBehind="headphones.aspx.cs" Inherits="webStore.headphones" %>
    ...
    <form id="form1" runat="server">
        ...
        <table class="nav-justified">
            <tr>
                ...
                <td class="auto-style4">Headphones</td>
                ...
                <td class="auto-style7">
                    <asp:GridView ID="GridView1" runat="server" AllowPaging="True" GridLines="None" AutoGenerateColumns="False" DataKeyNames="id_product" DataSourceID="SqlDataSource1" Height="350px" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" Width="950px">
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="id_product" HeaderText="Product Name" InsertVisible="False" ReadOnly="True" SortExpression="id_product" />
                    ...
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:OtherConnectionString2 %>" SelectCommand="SELECT [product_name], [price], [image], [id_product], [id_category], [visible] FROM [Products] WHERE (([visible] = @visible) AND ([id_user] != @id_user) AND ([id_category] = @id_category))">
                        <SelectParameters>
                            ...
                            <asp:Parameter DefaultValue="11" Name="id_category" Type="Int32" />
                        </SelectParameters>
                    </asp:SqlDataSource>
                </td>
